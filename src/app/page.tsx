...
function VisaLogo({ small }: { small?: boolean }) {
  const h = small ? 14 : 20;
  return (
    <svg height={h} viewBox="0 0 1000 324" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ overflow: "visible" }}>
      <path d="M413.58 2.4L316.15 308.32H236.89L188.46 51.82C185.55 39.26 183.03 34.62 173.03 29.16C156.78 20.33 130.6 12.09 107.51 7.07L109.46 2.4H238.26C254.58 2.4 269.17 13.09 272.79 31.7L303.11 194.28L382.01 2.4H413.58ZM717.49 207.41C717.63 121.7 601.74 117.11 602.58 79.04C602.84 67.74 613.62 55.68 637.13 52.55C648.78 51 681.85 49.73 719.26 67.07L734.18 5.9C714.17 -1.02 688.6 -7.6 657.02 -7.6C581.48 -7.6 528.02 32.96 527.63 92.13C527.21 135.46 566.74 159.59 596.63 174C627.43 188.78 637.84 198.27 637.7 211.33C637.49 231.29 613.94 240.18 591.89 240.52C549.92 241.14 525.58 228.7 506.27 219.55L490.86 282.85C510.26 292.02 547.47 299.94 586.09 300.34C666.75 300.34 719.38 261.17 717.49 207.41ZM895.01 308.32H965.6L903.8 2.4H839.64C825.39 2.4 813.31 10.63 808.04 23.28L694.86 308.32H775.48L791.2 263.01H889.64L895.01 308.32ZM814.52 202.06L854.93 88.61L878.15 202.06H814.52ZM494.27 2.4L432.01 308.32H355.59L417.87 2.4H494.27Z" fill="white"/>
    </svg>
  );
}
